...
const projects = [
	{
		...
		title: 'Fanta F1 Game',
		description:
			'Full-stack React PWA with Firebase for a real-time F1 fantasy league: automatic result fetching via REST API, live standings, sprint races, joker bonuses, admin panel, push notifications, and CI/CD.',
		image: '/fantaf1.png',
